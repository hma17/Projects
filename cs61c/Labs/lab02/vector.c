...
/*need to malloc the vectore itself ti have the pointers 
and attributes of the vector
needs to malloc an int pointer*/
...
void vector_set(vector_t* v, size_t loc, int value) {
  ...
  if (loc > v->size) {
    int* newArray = calloc(loc + 1, sizeof(int));
